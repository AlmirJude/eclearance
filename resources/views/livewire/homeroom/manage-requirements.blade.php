            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-lg w-full mx-4">
                ...
                <div class="px-6 py-4 space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="name" class="w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400" placeholder="e.g., Parent Consent Form">
