                    ...
                    <tr class="border-b hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-2">
                            <span class="px-2 py-1 text-xs rounded
                                {{ $signatory->position === 'moderator' ? 'bg-purple-100 text-purple-700' : '' }}
                                {{ $signatory->position === 'president' ? 'bg-blue-100 text-blue-700' : '' }}
                                {{ $signatory->position === 'treasurer' ? 'bg-green-100 text-green-700' : '' }}">
                                    ...
                                    <label class="flex items-center gap-3 p-3 hover:bg-blue-50 cursor-pointer border-b border-gray-200 last:border-b-0 transition">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-semibold text-gray-900 truncate">
                                                {{ $user->fullname }}
                                                <span class="ml-1 px-1.5 py-0.5 text-xs rounded {{ $user->role === 'student' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700' }}">
                                                    {{ ucfirst($user->role) }}
                                                </span>
                                            </p>
