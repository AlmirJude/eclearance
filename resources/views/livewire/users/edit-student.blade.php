<div>
    ...
    <form wire:submit.prevent="save" class="space-y-4">
        ...
        <div class="space-y-4">
            ...
            <flux:input wire:model.live='student_id' label="Student ID" placeholder="Student ID (will be used as login ID)" inputmode="numeric" pattern="[0-9-]*" maxlength="8" oninput="this.value = this.value.replace(/[^0-9-]/g, '').slice(0, 8)" />
