<div class="p-6">
    {{-- Header --}}
    <div class="mb-6">
        <flux:heading size="xl">{{ $club->name }}</flux:heading>
        <p class="text-gray-600 mt-2">Club Overview & Clearance Analytics</p>
        @if($club->type)
            <span class="inline-flex items-center px-3 py-1 mt-2 rounded-full text-sm font-medium 
                {{ $club->type === 'academic' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800' }}">
                {{ ucfirst($club->type) }} Club
            </span>
        @endif
    </div>
    ...
    @else
        ...
        @if(count($departments) > 0)
            <div class="mb-6 flex items-center gap-4">
                ...
                <select 
                    ...
                    class="rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                >
                ...
                @if($departmentFilter)
                    <button 
                        ...
                        class="text-sm text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 underline"
                    >
                        Clear Filter
                    </button>
                @endif
        ...
        <div class="mb-8 bg-gradient-to-r from-purple-500 to-indigo-600 dark:from-purple-700 dark:to-indigo-800 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="mt-2 flex items-baseline">
                        ...
                        <span class="ml-2 text-lg opacity-75">of members completed</span>
                    </div>
                    <p class="mt-2 opacity-75">{{ $completedCount }} out of {{ $totalMembers }} members</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            ...
            @if(count($yearLevelStats) === 0)
                <div class="p-6 text-center text-gray-500 dark:text-gray-400">
                    @if($departmentFilter)
                        <p>No members from this department in this club.</p>
                    @else
        ...
        <div class="mt-6 flex flex-wrap gap-3">
            <a href="{{ route('club.members', $clubId) }}" 
            class="inline-flex items-center px-4 py-2 bg-purple-600 dark:bg-purple-700 text-white rounded-lg hover:bg-purple-700 dark:hover:bg-purple-800 transition">
                <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                Manage Members
            </a>
            <a href="{{ route('club.signatories', $clubId) }}" 
