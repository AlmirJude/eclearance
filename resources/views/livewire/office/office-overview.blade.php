                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($yearLevelStats as $stat)
                                <tr class="cursor-pointer hover:bg-teal-50 dark:hover:bg-teal-900/30 transition-colors"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium
                                            {{ $selectedYearLevel === $stat['year_level'] ? 'bg-teal-600 text-white' : 'bg-teal-100 dark:bg-teal-900/50 text-teal-800 dark:text-teal-300' }}">
                                ...
                                @if($selectedYearLevel === $stat['year_level'])
                                    <tr>
                                        <td colspan="7" class="px-0 pb-0 pt-0 bg-teal-50 dark:bg-teal-900/20">
                                            <div class="px-6 py-4">
                                                    ...
                                                    <table class="min-w-full text-sm">
                                                        <thead>
                                                            <tr class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                                                                ...
                                                                <th class="pr-6 py-2 text-left">Office Signed At</th>
                                                                <th class="pr-6 py-2 text-left">Signed By</th>
                                                                <th class="py-2 text-left">Clearance Completed At</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody class="divide-y divide-teal-100 dark:divide-teal-800">
                                                            @foreach($yearLevelDetails as $detail)
                                                                <tr class="hover:bg-teal-100/50 dark:hover:bg-teal-800/30">
